...
async def show_saas_instruction(callback: CallbackQuery):
    text = (
        ...
        "<b>1. Подготовка</b>\n"
        "─ Получи API-ключ в личном кабинете GdeSlon.\n"
        "─ Введи его в боте: «⚙️ Настройки» → «🔑 Изменить API-ключ GdeSlon».\n"
        ...
        "<b>3. Выбор категорий</b>\n"
        "─ Нажми «📂 Категории» и отметь интересующие тебя темы (одежда, электроника, товары для дома и др.).\n"
        "─ Сразу после выбора бот загрузит первые товары в твой персональный каталог.\n\n"
        "<b>4. Автоматический постинг</b>\n"
        "─ Бот самостоятельно наполняет твой каталог товарами из GdeSlon каждые 3 часа.\n"
        "─ Посты выходят автоматически с уникальным описанием (ИИ-рерайт), партнёрской ссылкой и маркировкой (ERID).\n"
        "─ Частота публикации зависит от твоего тарифа: Базовый — 12 постов/день, Профи — 48 постов/день, VIP — 96 постов/день.\n\n"
        "<b>5. Ночной режим и очередь</b>\n"
        "─ С 23:00 до 08:00 (МСК) посты не выходят, а сохраняются в твою личную очередь.\n"
        "─ Ты можешь в любой момент нажать «🚀 Опубликовать сейчас (Force Post)» в настройках, и случайный товар из каталога выйдет мгновенно (даже ночью).\n\n"
        "<b>6. Авто-закреп</b>\n"
...
def setup_scheduler(bot: Bot) -> AsyncIOScheduler:
    ...
    scheduler.add_job(refill_all_catalogs, trigger="interval", hours=1, kwargs={"bot": bot}, id="refill_catalogs", replace_existing=True)
