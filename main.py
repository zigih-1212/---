    ...
    if not user["oferta_accepted"]:
        if role == "saas":
            ...
            text_oferta = (
                ...
                "• Баланс – справочные данные о вознаграждении, не электронные деньги.\n\n"
                "<b>2. Предмет</b>\n"
                "Вы получаете бесплатный доступ к автоматическому размещению товарных постов с партнёрскими ссылками в ваших Telegram-каналах. "
                "Доход от продаж распределяется: <b>70%</b> – блогеру, <b>30%</b> – сервису.\n\n"
                "<b>3. Реферальная система</b>\n"
                "• Приглашая других блогеров по вашей реферальной ссылке, вы получаете <b>10%</b> от их заработка.\n"
                "• Реферальные начисления поступают на ваш баланс по мере подтверждения заказов.\n"
                "• Запрещено использовать спам или обманные методы для привлечения рефералов.\n\n"
                "<b>4. Учёт и выплаты</b>\n"
                "• Единственный источник данных о заказах – CPA-сеть.\n"
                "• <b>В ожидании</b> – заказы на проверке у рекламодателя (30–90 дней).\n"
                "• <b>Доступно к выводу</b> – подтверждённые заказы, готовые к выплате.\n"
                "• Выплата производится по запросу через бота, на указанные реквизиты.\n"
                "• Минимальная сумма для запроса выплаты: 3000 ₽.\n\n"
                "<b>5. Запрещено</b>\n"
                "Спам, накрутка, самовыкупы, мотивированный трафик, брендовая реклама, размещение партнёрских ссылок вне добавленных каналов. "
                "Любое нарушение влечёт блокировку аккаунта и аннулирование баланса.\n\n"
                "<b>6. Ответственность</b>\n"
                "• Выплаты ограничены суммами, реально полученными от CPA-сети.\n"
                "• При обнаружении фрода или блокировке аккаунта в CPA-сети баланс обнуляется.\n"
                "• Администрация вправе заморозить выплаты на время проверки (до 90 дней).\n\n"
                "<b>7. Изменения</b>\n"
                "Администрация может менять условия. Продолжение использования – согласие с новой редакцией."
            )
