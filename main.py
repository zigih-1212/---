...
async def show_saas_instruction(callback: CallbackQuery):
    text = (
        ...
        "<b>1. Подготовка</b>\n"
        "─ Бот автоматически получает товары из проверенных магазинов-партнёров (Admitad).\n"
        "─ Ручной ввод API-ключей не требуется.\n"
        "─ Оплатите подписку или активируйте промокод.\n\n"
        "<b>2. Подключение каналов</b>\n"
        "─ Перейдите в «📢 Мои каналы» и отправьте @username вашего канала (можно несколько).\n"
        "─ Бот проверит права администратора и добавит канал.\n\n"
        "<b>3. Автоматический постинг</b>\n"
        "─ Каждые 30 минут бот пополняет каталог свежими товарами с маркировкой ERID.\n"
        "─ Посты выходят автоматически с уникальным описанием (ИИ-рерайт) и партнёрской ссылкой.\n"
        "─ Частота публикации зависит от вашего тарифа.\n\n"
        ...
        "<b>6. Промокоды</b>\n"
        "─ В личном кабинете нажмите «🎁 Активировать промокод».\n"
        "─ Введите код и выберите канал — подписка продлится на 2 дня.\n\n"
