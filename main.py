...
async def show_saas_instruction(callback: CallbackQuery):
    text = (
        ...
        "─ Вы можете настроить частоту публикаций в веб-настройках (⚙️ Настройки → Основные).\n\n"
        "<b>6. Циклический постинг</b>\n"
        "─ В веб-настройках (⚙️ Настройки → Расписание) задайте периодичность для каждого магазина.\n"
        ...
        "─ В веб-настройках (⚙️ Настройки → Основные) выберите время жизни поста.\n"
...
async def show_blogger_instruction(callback: CallbackQuery):
    text = (
        ...
        "4. Настройте интервал постов в веб-настройках (⚙️ Настройки → Основные).\n"
